...
export class RequirementJobCandidateService {
  private _API = '';
  private _items: Array<RequirementJobDto> | undefined;
  private _item: RequirementJobDto | undefined;
  ...
  get API() {
    return this.environment.apiUrlRecruitmentsystemms1 + 'candidate/requirementJob/';
  }
